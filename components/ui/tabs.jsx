...
import { Code, Image as ImageIcon } from "lucide-react" // Example icons
...
const TabsTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    >
      {props.value === "software" && <Code className="w-4 h-4" />}
      {props.value === "graphic" && <ImageIcon className="w-4 h-4" />}
      {children}
    </motion.div>
  </TabsPrimitive.Trigger>
))

...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[320px] aspect-[17/10] max-h-52"
      ref={refElement}
      onPointerMove={(event) => {
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 -z-10 rounded-[var(--radius)] pointer-events-none"
        style={{
          background: "linear-gradient(120deg, #0b3f61 0%, #524094 100%)",
          filter: "blur(32px)",
          opacity: 0.5,
        }}
      />
